...
- **Income and credit:** revenue on the dashboard and in Reports is *money received*. It is what was paid at the till, plus credit paid back that day. The part of a bill left on credit is not counted on the bill's day; it counts on the day the customer pays it back, under the method they paid with, so nothing is counted twice. The Sales page shows *Credit paid back*, and adds it to Cash / Card / Other.
- **Reports:** besides revenue per day and station, top products and session modes, the page shows average ticket, play hours and occupancy, customers (new, walk-in), counter sales, discounts and credit left unpaid. It also shows busy hours, revenue by weekday, payment methods (including credit), revenue by room and console type, a station usage table with occupancy, product categories, and top customers (with what they owe). **Accounts** ranks every user by the money they took in, as a bar split into cash, card and other. Each user also gets a card showing their total and share, the method split, a small chart of money taken per day, receipts, sessions started, bills closed, credit paid back to them, discounts given and amounts left on credit. *Stations CSV* exports the usage table, and *Export PDF* includes every section.
